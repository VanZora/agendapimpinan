      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item <?php if($page=='pegawai'){ echo "active"; }?>">
              <a href="?page=pegawai" class="menu-link">
                <i class="menu-icon tf-icons bx bxs-user-detail"></i>
                <div data-i18n="Analytics">Pegawai</div>
              </a>
            </li>

            <li class="menu-item <?php if($page=='jabatan'){ echo "active"; }?>">
              <a href="?page=jabatan" class="menu-link">
